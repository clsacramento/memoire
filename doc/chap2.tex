...
Les applications de sécurité\index{Sécurité} réseaux traditionnelles\index{Traditionnel} ne voient pas la communication entre VMs au sein du même hyperviseur, à moins que toutes leurs communications ne soient routées à l'extérieur de la machine hôte vers l'application de sécurité et re-routées à l'intérieur. Cette manière de traiter la problématique introduit un ralentissement considérable du réseau. 
...
Les applications data centres ont évolué vers un modèle beaucoup plus dynamique pour accompagner et s'adapter aux demandes des consommateurs Cloud Computing\index{Cloud Computing}. Ce nouveau mode de livraison\index{Mode de livraison} et consommation exige une infrastructure beaucoup plus flexible et réactive pour fournir les ressources sollicitées. 
...
En résumé, il est difficile aujourd'hui d'atteindre le niveau d'agilité\index{Agilité} et sécurité exigé avec les technologies réseaux classiques sans introduire une complexité excessivement contraignante et donc bloquante pour l'implémentation du Cloud Computing\index{Cloud Computing}. Dans le chapitre suivant, il sera analysé de nouvelles\index{Innovation} applications SDN qui proposent des solutions pour aborder ces problématiques. 
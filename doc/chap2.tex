...
Chaque réseau est connecté à un routeur\index{Routeur}, qui doit être configuré pour prendre en compte ces VLANs. Le trafic\index{Trafic} doit toujours monter et descendre passant par ce routeur\index{Router} (réseau d'accès et de distribution), ce qui n'est pas très performant. La capacité du routeur peut limiter les communication inter-départements. 

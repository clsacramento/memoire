...
Ce scénario illustre la connexion des réseaux tenants au WAN pour l'accès aux sites distants. Dans l'approche traditionnelle, un VLAN doit être créé entre le routeur du data centre et le routeur WAN.

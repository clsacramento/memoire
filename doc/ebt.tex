...
\newglossaryentry{openstack}
{
  name=OpenStack,
  text=OpenStack,
  description={ OpenStack est un projet pour le développement d'une plateforme Cloud Computing \gls{opensource}. Le projet a été initié par NASA et Rackspace en 2010, et actuellement a été rejoint par diverses entreprises telles que HP, Dell, Cisco etc.

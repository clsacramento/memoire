...
Les centres de traitement de données\index{Data Centre} évoluent aujourd'hui à un rythme intense pour accompagner l'explosion constatée dans l'utilisation de données. L'accélération de l'innovation\index{Innovation} dans l'informatique impose une rénovation constante des entreprises. La virtualisation\index{Virtualisation} a permis aux centres de données d'améliorer la productivité de ses serveurs, mais pour arriver à l'agilité\index{Agilité} souhaitée, les data centres doivent faire évoluer leurs réseaux pour pouvoir passer au Cloud Computing\index{Cloud Computing}. Cette étude analyse les applications \gls{sdn}\index{SDN} pour distinguer quels sont les apports dans le contexte des data centres et habiliter le passage au Cloud Computing.
